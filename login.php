...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['email']) && isset($_POST['senha'])) {
    ...
    if (!$user) {
        ...
        // Verificar se está bloqueado e se o bloqueio expirou (15 minutos)
        ...
        if ($bloqueado && $ultimoErro) {
            ...
            if ($interval >= 900) { // 900 segundos = 15 minutos
                $bloqueado = false;
                $desbloqueio = true;

                // Resetar bloqueio e tentativas
        ...
        if ($bloqueado) {
            ...
            if (password_verify($pass, $user['password'])) {
                ...
                // Senha incorreta: aumentar tentativas
